...
- [[ouroboros-vs-compound-superpowers-comparison]] — Ouroboros vs Compound vs Superpowers 심층 비교 분석
...
- [[sokind-interview-qa-deep-dive-q1-q14]] — Senior Backend Engineer 면접 Q&A 심화 (Q1~Q14)
- [[sokind-senior-backend-engineer-analysis]] — 크디랩(쏘카인드) Senior Backend Engineer 분석
- [[sokind-senior-backend-engineer-interview-100qa]] — Senior Backend Engineer 기술 면접 Q&A 100선
...
- [[deep-research-architecture-sources]] — 4대 아키텍처 패턴 공식 참고 자료
- [[hexagonal-architecture-comprehensive]] — Hexagonal Architecture Comprehensive
...
### develop/claude-code
- [[agent-skills-cross-platform-compat]] — Agent Skills 오픈 표준과 Claude Code 플러그인 시스템
- [[agents-md-effect-on-known-tech-stacks]] — Skill 호출 확률, AGENTS.md 효과, 기술 스택별 분석 통합
- [[claude-code-hook-system]] — Claude Code Hook System
- [[claude-code-memory-claudemd-hook-qa]] — Claude Code Memory, CLAUDE.md, Hook Q&A
...
- [[nextjs-route-groups]] — Next.js 라우트 그룹 (Route Group) 정리: (auth)/(main) 폴더 구조, URL 미노출 레이아웃 공유, 일반 폴더와의 URL 차이, Multiple Root Layouts 사용 이유·예시, loading/error/template 스코핑, URL 충돌 규칙
...
- [[ml-engineering-for-video]] — GPU 기반 AI 영상 처리 플랫폼 설계
...
- [[00-synthesis]] — KICK 7개 리포트 종합 분석
- [[01-vc-investor]] — VC 투자자 조사 리포트
- [[02-coffee-maniac]] — 커피 매니아 조사 리포트
- [[03-quality-owner]] — 품질 사장님 조사 리포트
- [[04-franchise-ceo]] — 프랜차이즈 회장 조사 리포트
- [[05-market-skeptic]] — 시장 회의론자 조사 리포트
- [[06-solution-evaluator]] — 솔루션 평가자 조사 리포트
