...
주의: 생산성 수치(하루 40~60분 절감 등)는 Moderna·OpenAI 자체 보고 기반이며 제3자 감사 없음. AI 채택이 신약 개발 가속화 등 실제 사업 성과로 이어졌다는 인과는 현재 미입증 상태 `[Uncertain]`.
...
**레버리지 필요성**: CEO Bancel은 "수천 명으로 10만 명의 성과를 내야 한다"고 공개 천명. 자원 제약이 전사 AI 채택을 선택이 아닌 생존 조건으로 만들었다 `[Self-Reported]`.

**기술 부채 부재**: 경쟁사 대부분이 레거시 인프라와 씨름하는 동안, Moderna는 창사 초기부터 AWS 단일 클라우드를 선택해 10년간 데이터 거버넌스를 성숙시켰다. 이 선행 투자가 AI 도구를 14일 만에 배포하는 속도를 가능하게 했다 `[Self-Reported]`.
...
| 2023년 | AI Academy 기업 내재화 | CMU 외부 의존 탈피, 6트랙 맞춤 교육 체계로 재설계; mChat 채택률 80% `[Self-Reported]` |
...
| 2024년 | LinkedIn 'Top Companies' 9위 | AI 인력 적응 기준 평가 `[Independently-Audited]` |
...
> 출처: OpenAI case study, Fortune (2024.04, 2024.03, 2025.05), Fierce Pharma, CIO.com, UNLEASH, IntuitionLabs `[Self-Reported]` / LinkedIn Top Companies `[Independently-Audited]`
...
| 법무 | Contract Companion | 계약서 검토·핵심 조항 요약 | 계약 초안 작업 90~95% 시간 절감 `[Self-Reported]` |
| 법무 | Policy Bot | HR·안전 정책 Q&A 자동화 | 법무팀 100% 채택 |
| 규제 | Regulator Response | FDA 대응 초안 작성 | 대응 시간: 수주 → 수분 (내부 주장) `[Self-Reported]` |
...
| 지표 | 수치 | 측정 시점 | 라벨 |
|------|------|----------|------|
| ChatGPT Enterprise 전사 채택률 | 80% (mChat 포함) | 2024년 배포 후 | `[Self-Reported]` |
| 법무팀 채택률 | 100% | 2024년 | `[Self-Reported]` |
| 사용자당 주간 대화 수 | 120회 | 2024년 평균 | `[Self-Reported]` |
| GPT 생성 참여율 | 주간 활성 사용자의 40% | 2개월 내 | `[Self-Reported]` |
| 배포된 맞춤 GPT 수 | 750+ (초기) → 3,000+ (2025년) | 단계별 | `[Self-Reported]` |
| Slack AI 포럼 주간 참여자 | 약 2,000명 | 2024년 | `[Self-Reported]` |

### 6-2. AI 교육 지표 (측정 방법: AI Academy 수료 기록 + NPS 설문)

| 지표 | 수치 | 라벨 |
|------|------|------|
| AI Academy 누적 등록 (20개월) | 2,000명+ | `[Self-Reported]` |
| 총 학습 시간 | 14,700시간+ | `[Self-Reported]` |
| 평균 지식 향상률 (교육 전후 비교) | 약 30% | `[Self-Reported]` |
| 2023년 전사 참여율 | 25% | `[Self-Reported]` |
| AI Academy NPS | 71 (50↑ = 긍정) | `[Self-Reported]` |
| LinkedIn Top Companies AI 순위 | 9위 (2024년) | `[Independently-Audited]` |

### 6-3. 생산성·비용 주장 (측정 방법 미공개, 주의 요망)

| 주장 | 수치 | 라벨 |
|------|------|------|
| Enterprise GPT 사용자 일일 시간 절감 | 40~60분 | `[Self-Reported]` — 측정 방법 미공개 |
| Contract Companion 계약 초안 시간 절감 | 90~95% | `[Self-Reported]` — 단일 발화 인용 |
| 규제 대응 처리 시간 | 수주 → 수분 | `[Self-Reported]` — 검증 불가 |

### 6-4. 비즈니스 성과와의 인과 (현재 미입증)

AI 채택이 mRNA 신약 개발 가속, 임상 성공률 향상, 매출 회복 등 실제 사업 성과로 이어졌다는 인과관계는 현재 공개된 자료에서 입증되지 않는다 `[Uncertain]`.
...
| # | 출처 | URL | 유형 | 비고 |
|---|------|-----|------|------|
| 1 | OpenAI — Moderna case study | https://openai.com/index/moderna/ | `[Self-Reported]` | ChatGPT Enterprise 배포 수치의 1차 출처; OpenAI는 공급업체 |
...
| 3 | Fortune — "Moderna CIO Brad Miller" (2024.04.17) | https://fortune.com/2024/04/17/moderna-cio-brad-miller-covid-drugs-ai-cloud/ | `[Self-Reported]` | Brad Miller 인터뷰, mChat·AWS 결정 세부 |
| 4 | Fortune — "Moderna AI upskilling" (2024.03.18) | https://fortune.com/2024/03/18/moderna-ai-upskilling-program-chro-tracey-franklin/ | `[Self-Reported]` | Tracey Franklin 인터뷰, AI Academy 재설계 세부 |
| 5 | Fortune — "Moderna leader AI conflict" (2025.05.19) | https://fortune.com/2025/05/19/moderna-leader-ai-resolve-conflictexecutive-teamall-before-it-happens/ | `[Self-Reported]` | Franklin의 AI 갈등 예측 모델 활용 사례 |
| 6 | CIO.com — "Moderna's HR-IT merger: Trend or exception" | https://www.cio.com/article/4002321/modernas-hr-it-merger-trend-or-exception-to-the-rule.html | `[Independently-Audited]` | Ken Knapton 박사(독립 분석가) 비판적 평가 |
| 7 | UNLEASH — "Why Moderna merged HR and IT" | https://www.unleash.ai/artificial-intelligence/why-moderna-merged-hr-and-it-to-better-architect-the-flow-of-work/ | `[Self-Reported]` | Franklin 인터뷰, 통합 철학 상세 |
| 8 | FlexOS — "Moderna Merges HR & IT" | https://www.flexos.work/learn/moderna-merges-hr-it-new-chief-manages-3000-ai-and-5800-humans | `[Self-Reported]` | 3,000 AI + 5,800인 통합 관리 수치 |
| 9 | IntuitionLabs — Moderna AI Adoption Case Study | https://intuitionlabs.ai/articles/moderna-ai-adoption-case-study | `[Self-Reported]` | 타임라인·교육 지표 종합; OpenAI 자료 재가공 |
| 10 | CMU News — "Moderna AI Academy" (2021.12) | https://www.cmu.edu/news/stories/archives/2021/december/moderna-ai-academy.html | `[Independently-Audited]` | CMU 공식 발표; AI Academy 출범 1차 확인 |
| 11 | PharmExec — "How Moderna is Implementing AI and ChatGPT" (2024.06) | https://www.pharmexec.com/view/moderna-implementing-ai-chatgpt | `[Self-Reported]` | Brice Challamel 인터뷰, Contract Companion 90~95% 절감 주장 |
| 12 | AI Native Foundation — Moderna Case Study 8 | https://ainativefoundation.org/ai-native-case-study-8-moderna/ | `[Self-Reported]` | 주의: "AI 생성 평가, 데이터 미뒷받침"이라고 자체 고지 |
