...
> **하위 개념 상세**: [[aws-iam-user-concept-explainer]], [[aws-iam-group-concept-explainer]], [[aws-iam-policy-concept-explainer]], [[aws-iam-role-concept-explainer]]
...
| 구성요소 | 역할 | 비유 | 상세 문서 |
|---------|------|------|----------|
| **User** | 개별 사용자/애플리케이션 신원 | 사원증 | [[aws-iam-user-concept-explainer]] |
| **Group** | User 집합, 권한 일괄 부여 | 부서 카드 | [[aws-iam-group-concept-explainer]] |
| **Policy** | JSON 권한 문서 (Allow/Deny) | 출입 규칙표 | [[aws-iam-policy-concept-explainer]] |
| **Role** | 임시 자격증명 기반 신원 | 임시 방문증 | [[aws-iam-role-concept-explainer]] |
...
> - 관련 문서: [[aws-iam-user-concept-explainer]], [[aws-iam-group-concept-explainer]], [[aws-iam-policy-concept-explainer]], [[aws-iam-role-concept-explainer]], [[aws-iam-architecture-and-integration]]
